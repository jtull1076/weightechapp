  ...
  Widget build(BuildContext context) {
    return ScaffoldPage(
      ...
      Container(
          ...
          child: Hero(
              tag: 'main-logo',
              child: Image.asset('assets/weightech_logo_beta.png',
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage(
      ...
      Center(
        ...
        (message != null) ? Text("$message") : const Text("Unknown error."),
    ...
    if (!await InternetConnection().hasInternetAccess) {
      if (mounted) {
        await Navigator.of(context).push(PageRouteBuilder(
            pageBuilder: (BuildContext context, _, __) => const OfflinePage()));
      }
    }
                                ...
                                Center(
                                    child: UpdatWidget(
                                        ...
                                        getLatestVersion: () async {
                                          ...
                                          try {
                                            final data = await http.get(
                                                ...
                                                headers: {
                                                  'Authorization':
                                                      'Bearer ${FirebaseUtils.githubToken}'
                                                });
                                            final latestVersion = jsonDecode(
                                                data.body)["tag_name"];
                                            final verCompare =
                                                AppInfo.versionCompare(
                                                    latestVersion,
                                                    AppInfo
                                                        .packageInfo.version);
                                            Log.logger.i(
                                                'Latest version: $latestVersion : This app version is ${(verCompare == 0) ? "up-to-date." : (verCompare == 1) ? "deprecated." : "in development."}');
                                            return latestVersion;
                                          } catch (e) {
                                            Log.logger.e(
                                                "Error encounted retrieving latest version.",
                                                error: e);
                                          }
                                          return null;
                                        },
                                        ...
                                        getChangelog: (_, __) async {
                                          ...
                                          Log.logger.t(
                                              'Changelog: ${jsonDecode(data.body)["body"]}');
...
class _ControlPageState extends State<ControlPage>
    ...
    return CallbackShortcuts(
        bindings: <ShortcutActivator, VoidCallback>{
            ...
            if (_focusItem is EProduct) {
              ...
              if (_addingItem) {
                ...
                ECategory newECategory =
                    ECategory(category: newCategory, editorItems: []);

                newECategory.save(
                    parent: _selectedCategory,
                    imagePath: (_mediaPaths.isEmpty) ? null : _mediaPaths.first,
                    imageFile:
                        (_mediaFiles.isEmpty) ? null : _mediaFiles.first);
              } else {
          ...
          const SingleActivator(LogicalKeyboardKey.keyS,
              control: true, alt: true): () async {
            if (CatalogEditor.isLocal && CatalogEditor.currentFile != null) {
              await handleSaveCatalogLocal(
                  path: CatalogEditor.currentFile!.path);
            } else {
              FilePickerResult? _ = await FilePicker.platform
                  .saveFile(
                      dialogTitle: 'Save As',
                      fileName: '${_filenameController.text}.wtf',
                      allowedExtensions: ['wtf'],
                ...
                if (result != null) {
                  ...
                  setState(() {
                    _filenameController.text =
                        FileUtils.filename(CatalogEditor.currentFile!.path);
                  });
                } else {
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: IntrinsicWidth(
                                            ...
                                            child: TextBox(
                                              ...
                                              padding: EdgeInsets.zero,
                                              suffix: Row(children: [
                                                (!CatalogEditor.isLocal)
                                                    ? const Icon(
                                                        FluentIcons
                                                            .cloud_20_regular,
                                                        color: Colors.white)
                                                    : const SizedBox(),
                                                (CatalogEditor.isUnsaved)
                                                    ? const Text('*',
                                                        style: TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 12))
                                                    ...
                                                    wrappedItem:
                                                      ...
                                                      onPressed: () async {
                                                        FilePickerResult? _ = await FilePicker.platform
                                                          ...
                                                          .then((result) async {
                                                            if (result != null) {
                                                              (_focusItem! as EProduct).printToPdf(path: result);
                                                            } else {
                                                              Log.logger.t("-> File save aborted/failed.");
                                                              return null;
                                                            }
                                              ...
                                              if (!_addingItem &&
                                                ...
                                                CommandBarBuilderItem(
                                                    ...
                                                    wrappedItem:
                                                        CommandBarButton(
                                                      icon: const Icon(FluentIcons
                                                          .arrow_counterclockwise_20_regular),
                                                      label: const Text(
                                                          'Revert',
                                                          style: TextStyle(
                                                              fontSize: 12)),
                                                      onPressed: () async {
                                                        ...
                                                        if (confirmed) {
                                                          ...
                                                          Log.logger.i(
                                                              'Reverting ${item.name} (ID: ${item.id}) to its published version...');
                                      ...
                                      IntrinsicWidth(
                                          child: CommandBar(
                                        overflowBehavior:
                                            CommandBarOverflowBehavior.wrap,
                                        mainAxisAlignment:
        ...
        nodeBuilder: (BuildContext context, TreeEntry<EItem> entry) {
          return TreeDragTarget<EItem>(
            ...
            onNodeAccepted: (TreeDragAndDropDetails details) {
              ...
              if (targetParent == draggedNode.getParent()) {
                details.mapDropPosition(
                  whenAbove: () {
                    final newIndex =
                        targetParent!.editorItems.indexOf(targetNode);
                  ...
                  whenBelow: () {
                    if (entry.isExpanded) {
                      if (targetNode is ECategory) {
                        ...
                        draggedNode.reassignParent(
                            newParent: newParent, atIndex: 0);
                      }
                    } else {
                      final newIndex =
                          targetParent!.editorItems.indexOf(targetNode) + 1;
                ...
                details.mapDropPosition(
                  whenAbove: () {
                    ...
                    (draggedNode).reassignParent(
                        newParent: targetParent, atIndex: newIndex);
                  },
                  whenInside: () {
                    if (targetNode is ECategory) {
                      (draggedNode).reassignParent(newParent: targetNode);
                  ...
                  whenBelow: () {
                    if (entry.isExpanded) {
                      if (targetNode is ECategory) {
                        (draggedNode)
                            .reassignParent(newParent: targetNode, atIndex: 0);
                      }
                    } else {
                      final newIndex =
                          targetParent!.editorItems.indexOf(targetNode) + 1;
            ...
            builder: (BuildContext context, TreeDragAndDropDetails? details) {
              ...
              const borderSide =
                  BorderSide(color: Color(0xFF9E9E9E), width: 1.5);
              ...
              if (details != null) {
                ...
                decoration = BoxDecoration(
                  ...
                  border: details.mapDropPosition(
                    ...
                    whenInside: () => (entry.node is ECategory)
                        ? const Border.fromBorderSide(borderSide)
                        : null,
                    whenBelow: () => entry.isExpanded
                        ? null
                      ...
                      child: SizedBox(
                        ...
                        child: ListTile(
                          ...
                          leading: (entry.node is ECategory)
                              ? (entry.isExpanded)
                                  ? const Icon(
                                      FluentIcons.list_bar_tree_20_regular)
      ...
      onDragDone: (detail) {
        ...
        for (var file in detail.files) {
          ...
          if (extension == ".jpg" || extension == ".png") {
            ...
            Log.logger
                .t("-> Invalid file type: File type $extension not supported.");
          }
        }
          ...
          child: Column(children: [
            CarouselSlider.builder(
                ...
                itemBuilder:
                  ...
                  if (FileUtils.isLocalPathAndExists(
                      path: _mediaPaths[itemIndex])) {
                          ...
                          : DropTarget(
                              onDragDone: (detail) {
                                ...
                                for (var file in detail.files) {
                                  ...
                                  String extension =
                                      file.path.substring(file.path.length - 4);
                                  if (extension == ".jpg" ||
                                      extension == ".png") {
                                    Log.logger.t(
                                        "-> Image added to paths: ${file.path}");
                                    paths.add(file.path);
                                  } else if (file.path
                                          .substring(file.path.length - 5) ==
                                      ".jpeg") {
                                    Log.logger.t(
                                        "-> Image added to paths: ${file.path}");
                                    paths.add(file.path);
                              ...
                              child: AnimatedContainer(
                                  ...
                                  child: Column(
                                      ...
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        const Icon(FluentIcons.image_20_regular,
                                            size: 70),
                                        const Text("Drag and drop file here",
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold)),
                                        ...
                                        OutlinedButton(
                                            ...
                                            child: const Text("Browse Files")),
                                        const SizedBox(height: 10),
                                        const Text("File must be .jpg or .png",
                                            style: TextStyle(
                                                fontSize: 12.0,
                                                fontStyle: FontStyle.italic))
                                      ])),
        ...
        child: Container(
            ...
            child: Column(children: [
                  ...
                  onPressed: () async {
                    ...
                    switch (firstItem) {
                      case ECategory _:
                        {
                          _mediaPaths = [
                            (await category.editorItems.first.getImagePaths())
                          ];
                          _mediaFiles = [
                            (await category.editorItems.first
                                .getImageFiles(path: _mediaPaths[0]))
                          ];
                        }
                      case EProduct _:
                        {
                          ...
                          _mediaFiles = [
                            (await category.editorItems.first
                                .getImageFiles(paths: [_mediaPaths[0]]))[0]
                          ];
                        }
                    }
                    setState(() {});
              ...
              (category != null)
                  ? SizedBox(
                      height: 20,
                      child: Text("Item ID: ${category.id}",
  ...
  Future<void> toggleEditorItem(EItem? focusItem,
      {bool newItem = false}) async {
    StreamController<String> updateStreamController =
        StreamController<String>();

    setState(
        () => _toggleLoading(dynamicStream: updateStreamController.stream));
    switch (focusItem) {
      case EProduct _:
        {
          ...
          updateStreamController
              .add("Downloading product media...\nThis might take a moment...");
          List<File> newImageFiles =
              await focusItem.getImageFiles(paths: newImagePaths) ?? [];
      ...
      case ECategory _:
        {
          ...
          File? newImageFile =
              await focusItem.getImageFiles(path: newImagePath);
          updateStreamController.add('Loading...');
          _mediaPaths.clear();
          _mediaFiles.clear();
          _focusItem = focusItem;
                ...
                if (snapshot.hasData) {
                  if (snapshot.data is String) {
                    ...
                    return ContentDialog(
                        ...
                        content: Center(heightFactor: 1, child: snapshot.data));
                  } else {
                    return ContentDialog(
                        title: Center(
                          heightFactor: 1,
  ...
  Future<bool> _showItemDeleteDialog(BuildContext context, EItem data,
              ...
              builder: (BuildContext context) {
                return StatefulBuilder(builder: (context, setState) {
                  return ContentDialog(
                      ...
                      content: Text(
                          "You are about to delete ${currentName ?? data.category.name} and all of its contents (including sub-products). This action cannot be undone. \n\nAre you sure?"),
                      actions: <Widget>[
                        Button(
              ...
              builder: (BuildContext context) {
                return StatefulBuilder(builder: (context, setState) {
                  return ContentDialog(
                      title: const Text("Warning!"),
                      content: Text(
                          "You are about to delete ${currentName ?? data.product.name} and all of its contents. This action cannot be undone. \n\nAre you sure?"),
                      actions: <Widget>[
                        Button(
                            child: const Text("Delete"),
                            onPressed: () {
  ...
  Future<bool> _showItemRevertDialog(BuildContext context, EItem data,
      {String? currentName}) async {
    bool? confirmation = false;
              ...
              builder: (BuildContext context) {
                return StatefulBuilder(builder: (context, setState) {
                  return ContentDialog(
                      title: const Text("Warning!"),
                      content: Text(
                          "You are about to revert ${currentName ?? data.category.name} (ID: ${data.id}) to its most-recent published version. Note that this will revert all of its contents. This action cannot be undone. \n\nAre you sure?"),
                      actions: <Widget>[
                        Button(
              ...
              builder: (BuildContext context) {
                return StatefulBuilder(builder: (context, setState) {
                  return ContentDialog(
                      title: const Text("Warning!"),
                      content: Text(
                          "You are about to revert ${currentName ?? data.product.name} to its most-recent published version. This action cannot be undone. \n\nAre you sure?"),
                      actions: <Widget>[
                        Button(
                            child: const Text("Revert"),
                            onPressed: () {
  ...
  Future<void> _showPreviewDialog(BuildContext context) async {
    ...
    await showDialog<bool>(
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (context, setState) {
            List<Map<String, dynamic>> tempBrochure =
                mapListToBrochure(_brochure);
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: ListView(
                                padding: const EdgeInsets.only(
                                    left: 42, right: 14, top: 21),
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                children: [
                                  SimpleRichText(_descriptionController.text,
                                  ...
                                  Column(children: [
                                    CarouselSlider.builder(
                                        ...
                                        itemBuilder: (BuildContext context,
                                          ...
                                          return FutureBuilder(
                                              future: (FileUtils.isURL(
                                                      path: _mediaPaths[
                                                          itemIndex]))
                                                  ? FileUtils.cacheManager
                                                      .getSingleFile(
                                                          _mediaPaths[
                                                              itemIndex])
                                                  : Future.delayed(
  ...
  Future<Map<String, dynamic>?> _showRestorationDialog(
    BuildContext context,
  ) async {
    _toggleLoading();
    List<Map<String, dynamic>> catalogOptions =
        await FirebaseUtils.getLastFromFirestore(3);
    _toggleLoading();
                  ...
                  itemBuilder: (statefulContext, index) {
                    return ListTile(
                        ...
                        title: Row(
                            ...
                            children: [
                              Text(
                                  (catalogOptions[index]['catalogName'] ??
                                          'Untitled') +
                                      '  ',
                                  style: const TextStyle(fontSize: 16)),
                              Text(
                                  DateFormat('MMM d, y h:mm a').format(
                                      DateTime.fromMillisecondsSinceEpoch(
                                          catalogOptions[index]['timestamp']
                        ...
                        onPressed: () async {
                          final confirmed = await _showRestorationConfirmation(
                              context,
                              DateFormat('MMM d, y h:mm a').format(
                                  DateTime.fromMillisecondsSinceEpoch(
                                      catalogOptions[index]['timestamp']
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (context, setState) {
            return ContentDialog(
                title: const Text("Warning!"),
                content: const Text(
                    "You are about to publish this version of the catalog.\n\nAre you sure?"),
                actions: <Widget>[
                  Button(
  ...
  Future<bool> _showRestorationConfirmation(
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (context, setState) {
            return ContentDialog(
                title: const Text("Warning!"),
                content: Text(
                    "You are about to restore this catalog to one from $date. You will lose your unsaved progress.\n\nAre you sure?"),
                actions: <Widget>[
                  Button(
                  ...
                  child: UpdatWidget(
                      ...
                      getLatestVersion: () async {
                        ...
                        try {
                          ...
                          final verCompare = AppInfo.versionCompare(
                              latestVersion, AppInfo.packageInfo.version);
                          Log.logger.i(
                              'Latest version: $latestVersion : This app version is ${(verCompare == 0) ? "up-to-date." : (verCompare == 1) ? "deprecated." : "in development."}');
                          return latestVersion;
                        } catch (e) {
                      ...
                      getChangelog: (_, __) async {
                        ...
                        Log.logger
                            .t('Changelog: ${jsonDecode(data.body)["body"]}');
                        return jsonDecode(data.body)["body"];
                      },
                      ...
                      Flexible(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 5),
                                Text(
                                    "App Version: ${AppInfo.packageInfo.version}",
                                    style: FluentTheme.of(context)
                                        .typography
                                        .bodyLarge
  ...
  Future<void> handleSaveCatalogLocal(
      {required String path, bool isBackup = false}) async {
    final streamController = StreamController();
    setState(() => _toggleLoading(
        dynamicStream: streamController.stream, loadingSomething: true));
    await CatalogEditor.saveCatalogLocal(
  ...
  void onWindowClose() async {
    ...
    TextEditingController unsavedNameController =
        TextEditingController(text: CatalogEditor.name);
    Directory currentDirectory = (CatalogEditor.currentFile != null)
        ? CatalogEditor.currentFile!.parent
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: ListTile(
                            ...
                            title:
                                Text(FileUtils.filename(currentDirectory.path)),
                            onPressed: () async {
                              FilePickerResult? _ = await FilePicker.platform
                                  .saveFile(
                                      dialogTitle: 'Save As',
                                      fileName:
                                          '${unsavedNameController.text}.wtf',
                                      allowedExtensions: ['wtf'],
                                      type: FileType.custom)
                                  .then((result) async {
                                if (result != null) {
                                  ...
                                  await handleSaveCatalogLocal(
                                      path: unsavedNameController.text);
                                } else {
                                  Log.logger.t("-> File save aborted/failed.");
                                  return null;
                                }
